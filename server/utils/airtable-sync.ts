  ...
  try {
    ...
    const orders: Order[] = data.records.map((record: any) => {
      ...
      return {
        ...
        customerPhone: fields["customer_mobile_number"] || "",
        billingAddress: fields["billing_address"] || "",
        country: fields["country"] || "",
        companyId: fields["company_id"] || "",
        companyName: fields["company_name"] || "",
        companyNumber: fields["company_numbers"] || "",
        paymentMethod: fields["payment_method"] || "credit_card",
        paymentStatus: fields["payment_status"] || "pending",
        transactionId: fields["transaction_id"] || "",
        amount: fields["amount"] ? parseFloat(String(fields["amount"])) : 0,
        currency: fields["currency"] || "USD",
        paymentDate: fields["order_date"] || now,
        status: fields["status"] || "pending-payment",
        statusChangedDate: fields["last_update_date"] || new Date().toISOString().split("T")[0],
        statusHistory: fields["status_history"] ? JSON.parse(fields["status_history"]) : [],
        purchaseDate: fields["order_date"] || now,
        lastUpdateDate: fields["last_update_date"] || now,
        renewalDate: fields["renewal_date"] || "",
        renewalFees: fields["renewal_fees"] ? parseFloat(String(fields["renewal_fees"])) : 0,
        refundStatus: fields["refund_status"] || "none",
        refundRequest: undefined,
        documents: fields["documents"] ? JSON.parse(fields["documents"]) : [],
        transferFormUrl: "",
        adminNotes: fields["any_other_notes"] || "",
        internalNotes: "",
