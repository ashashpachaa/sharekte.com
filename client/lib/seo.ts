...
export function getPageSEOMetadata(
  ...
  const pageMetadata: Record<string, SEOMetadata> = {
    home: {
      ...
      keywords:
        language === "ar"
          ? SEO_KEYWORDS_AR.general
          : language === "hi"
            ? SEO_KEYWORDS_HI.general
      ...
      ogTitle:
        language === "ar"
          ...
          : language === "hi"
            ? "तैयार कंपनी खरीदें"
            : "Buy Ready Made Companies",
      ogDescription:
        language === "ar"
          ? "تأسيس شركة جاهزة للبيع مع حساب بنكي دولي"
          : language === "hi"
            ? "तैयार कंपनी खरीदें और बिजनेस शुरू करें"
            : "Global ready-made companies for instant business setup",
      ...
      structuredData: {
        ...
        description:
          language === "ar"
            ? "منصة شراء الشركات الجاهزة"
            : language === "hi"
              ? "तैयार कंपनी खरीद मंच"
              : "Ready-made company marketplace",
        sameAs: [
    ...
    companies: {
      ...
      keywords:
        language === "ar"
          ? [...SEO_KEYWORDS_AR.general, ...SEO_KEYWORDS_AR.country]
          : language === "hi"
            ? [...SEO_KEYWORDS_HI.general, ...SEO_KEYWORDS_HI.country]
            : [...SEO_KEYWORDS.general, ...SEO_KEYWORDS.country],
      canonicalUrl: `${baseUrl}/companies`,
      ogTitle:
        language === "ar"
          ? "دليل الشركات الجاهزة"
          : language === "hi"
            ? "तैयार कंपनी निर्देशिका"
            : "Ready-Made Companies Directory",
      twitterCard: "summary_large_image",
      robots: "index, follow",
      structuredData: {
        "@context": "https://schema.org",
        ...
        description:
          language === "ar"
            ? "مجموعة من الشركات الجاهزة للبيع"
            : language === "hi"
              ? "तैयार कंपनियों का संग्रह"
              : "Collection of ready-made companies",
      },
    },
    checkout: {
      title:
    ...
    support: {
      ...
      keywords:
        language === "ar"
          ? SEO_KEYWORDS_AR.services
          : language === "hi"
            ? SEO_KEYWORDS_HI.services
